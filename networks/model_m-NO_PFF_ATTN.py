...
""" model: TransUnet-GAN-   NO-PFF-ATTN
"""
...
class Embeddings(nn.Module):
    ...
    def __init__(self, config, img_size, in_channels=3):
        ...
        if config.patches.get("grid") is not None:   # ResNet
            ...
            patch_size = (img_size[0] // 16 // grid_size[0], img_size[1] // 16 // grid_size[1])  # 256/16/16 (1 1) 2 2
            patch_size_real = (patch_size[0] * 16, patch_size[1] * 16)  # 16 16   32 32
    ...
    def forward(self, x):  # 2 3 256 256
        ...
        return embeddings, features, PDF_out
