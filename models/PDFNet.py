...
class look0(nn.Module):
    def __init__(self, in_filters, dilation_rate):
        ...
        self.conv_main = nn.Sequential(
            nn.Conv2d(in_filters, 32, kernel_size=3, stride=1, padding=dilation_rate, dilation=dilation_rate,
                      bias=False),
            nn.BatchNorm2d(32),
            nn.ReLU(inplace=True))
        self.conv_side = nn.Sequential(
            nn.Conv2d(32, 32, kernel_size=3, stride=1, padding=dilation_rate, dilation=dilation_rate, groups=32,
                      bias=False),
            nn.BatchNorm2d(32),
            nn.ReLU(inplace=True),
            nn.Conv2d(32, 32, kernel_size=3, stride=1, padding=dilation_rate, dilation=dilation_rate, groups=32,
...
class look(nn.Module):
    def __init__(self, in_filters, dilation_rate):
        ...
        self.conv_main = nn.Sequential(
            nn.Conv2d(in_filters, in_filters, kernel_size=3, stride=1, padding=dilation_rate, dilation=dilation_rate,
                      groups=in_filters, bias=False),
...
class PDFNet(nn.Module):
    def __init__(self, num_classes=2):
        ...
        self.s3 = nn.Sequential(nn.Conv2d(544, 12, kernel_size=1, stride=1, bias=False),
                                nn.BatchNorm2d(12),
                                nn.ReLU(inplace=True))
        ...
        self.s4 = nn.Sequential(nn.Conv2d(928, 12, kernel_size=1, stride=1, bias=False),
                                nn.BatchNorm2d(12),
                                nn.ReLU(inplace=True))
        ...
        self.s5 = nn.Sequential(nn.Conv2d(1312, 12, kernel_size=1, stride=1, bias=False),
                                nn.BatchNorm2d(12),
                                nn.ReLU(inplace=True))

        self.out = nn.Sequential(
            nn.Conv2d(60, num_classes, kernel_size=1, stride=1, bias=False),
            nn.Sigmoid())
...
#
# checkpoint_dir = "./PDFNet9-1-CamVid/"
# best_model_dir = "./PDFNet9-1-CamVid/"
#
...
#
# #ckp_path = "./PDFNet9-1-CamVid/checkpoint.pt"
#
...
#     #best_model_wts = copy.deepcopy(torch.load("./PDFNet9-1-CamVid/PDFNet9-1_weights.pt"))
#
#     #best_loss= min(loss_history["val"])
#     best_loss=float('inf')
#     o = open('./PDFNet9-1-CamVid/PDFNet9-1.txt','a')
...
#
# import os
# path2models= "./PDFNet9-1-CamVid/PDFNet9-1_"
...
#
# end = time.time()
# o = open('./PDFNet9-1-CamVid/PDFNet9-1-time.txt','w')
#
...
# plt.legend()
# plt.savefig('./PDFNet9-1-CamVid/PDFNet9-1.png', dpi = 300)
#
...
#
# print(iou_sum/101)
# o = open('./PDFNet9-1-CamVid/PDFNet9-1_IOU_val.txt','w')
#
...
#
# print(i_sum/233)
# o = open('./PDFNet9-1-CamVid/PDFNet9-1_IOU_test.txt','w')
#
...
# import csv
#
# with open('./PDFNet9-1-CamVid/PDFNet9-1-plot.csv', 'w') as f:
#     writer = csv.writer(f)
